...
public class SystemConfigController {
    ...
    public BaseResponseInfo upload(HttpServletRequest request, HttpServletResponse response) {
        BaseResponseInfo res = new BaseResponseInfo();
        try {
            logger.info(request.getRequestURI()+"上传文件");
            String savePath = "";
    ...
    private static String extractPathFromPattern(final HttpServletRequest request) {
        ...
        System.out.println("请求路径："+path);///systemConfig/static/bill/63/0_1635924975912.png
        String bestMatchPattern = (String) request.getAttribute(HandlerMapping.BEST_MATCHING_PATTERN_ATTRIBUTE);
        System.out.println("baseMatchpath:"+bestMatchPattern);
